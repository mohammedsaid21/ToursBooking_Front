...
const TourDetails = () => {
   ...
   const { data: tour, loading, error } = useFetch(`${BASE_URL}/tours/${id}`, flag)
   ...
   const submitHandler = async e => {
      ...
      if (!user || user === undefined || user === null) {
         notify({ info: "Please Sign in", status: "failed" });
      }
      try {
         const reviewObj = {
         ...
         if (res.ok) {
            notify({ info: result.message, status: "success" });
            setFlag(true)
         }

      } catch (error) {
         notify({ info: error.message, status: "failed" });
      }
   }
                        ...
                        <div className="tour__reviews mt-4">
                           ...
                           <Form onSubmit={submitHandler}>
                              ...
                              <div className="review__input">
                                 <input type="text" className='px-2' ref={reviewMsgRef} placeholder='share your thoughts' required />
